...
restore_or_remove "$HOME/.local/bin/omarchy-menu-images"
restore_or_remove "$HOME/.local/bin/omarchy-hyprland-monitor-focused"
...
restore_or_remove "$HOME/.local/bin/plasmarchy-capture-screenshot"
